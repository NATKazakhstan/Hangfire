...
Task Merge -Depends Build -Description "Run ILRepack /internalize to merge required assemblies." {
    ...
    Repack-Assembly @("Hangfire.SqlServer", "net45") @("Dapper.StrongName")
    ...
    Repack-Assembly @("Hangfire.SqlServer", "netstandard1.3") @("Dapper.StrongName")
    Repack-Assembly @("Hangfire.SqlServer", "netstandard2.0") @("Dapper.StrongName")
}
